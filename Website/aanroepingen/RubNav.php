		...
		<li>
			...
			<div >
				<div class="nav-column">
					<h3>Kasten</h3>
					<ul>
						<li><a href="rubriekenpagina.php">Kledingkast</a></li>
						<li><a href="rubriekenpagina.php">Dressoir</a></li>
						<li><a href="rubriekenpagina.php">Nachtkast</a></li>
						<li><a href="rubriekenpagina.php">Ladekast</a></li>
						<li><a href="rubriekenpagina.php">Vitrinekast</a></li>
						<li><a href="rubriekenpagina.php">Boekenkast</a></li>
						<li><a href="rubriekenpagina.php">Eikenhout</a></li>
						<li><a href="rubriekenpagina.php">Beukenhout</a></li>
				...
				<div class="nav-column">
					<h3>Schilderijen</h3>
					<ul>
						<li><a href="rubriekenpagina.php">Abstracten Schilderijen</a></li>
...
<br>
					...
					<ul>
						...
						<li><a href="rubriekenpagina.php">Klokken</a></li>
		...
		<li>
			<a href="rubriekenpagina.php">Auto's</a>
			<div>
				<div class="nav-column">
					<h3 class="orange">Related Categories</h3>
					<ul>
		...
		<li><a href="rubriekenpagina.php">Muziek en Instrumenten</a>
		<div>
				<div class="nav-column">
					<h3 class="orange">Related Categories</h3>
					<ul>
		...
		<li><a href="rubriekenpagina.php">Watersport en Boten</a>
		<div>
				<div class="nav-column">
					<h3 class="orange">Related Categories</h3>
					<ul>
